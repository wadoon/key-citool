...
class InteractionLogView(val interactionLog: InteractionLog, private var mediator: KeYMediator) : JPanel(), TabPanel {
    ...
    companion object {
        val ICON_AUTO_SAVE_ENABLED = IconFontProvider(FontAwesomeSolid5.MAGIC)
        val ICON_AUTO_SAVE_DISABLED = IconFontProvider(FontAwesomeSolid5.MAGIC, Color.gray)
        val ICON_LOAD = IconFontProvider(FontAwesomeSolid5.TRUCK_LOADING)
        val ICON_ADD_USER_ACTION = IconFontProvider(FontAwesomeRegular.STICKY_NOTE)
        val ICON_TOGGLE_FAVOURITE = IconFontProvider(FontAwesomeSolid5.HEART, Color.red)
        val ICON_MARKDOWN = IconFontProvider(FontAwesomeSolid5.MARKDOWN)
        val ICON_SHOW = IconFontProvider(FontAwesomeSolid5.BOOK_OPEN)

        val INTERLOG_LOAD: IconProvider = IconFontProvider(FontAwesomeSolid5.TRUCK_LOADING)
        ...
        val INTERLOG_TOGGLE_FAV: IconProvider = IconFontProvider(FontAwesomeSolid5.HEART)
        val JUMP_INTO_TREE: IconProvider = IconFontProvider(FontAwesomeSolid5.MAP_MARKED)
        val INTERLOG_TRY_APPLY: IconProvider = IconFontProvider(FontAwesomeSolid5.REDO)
        val INTERLOG_EXPORT_KPS: IconProvider = IconFontProvider(FontAwesomeSolid5.FILE_EXPORT)
        val INTERLOG_EXPORT_MARKDOWN: IconProvider = IconFontProvider(FontAwesomeSolid5.FILE_EXPORT)
        val INTERLOW_EXTENDED_ACTIONS: IconProvider = IconFontProvider(FontAwesomeSolid5.WRENCH)
        val INTERLOG_RESUME: IconProvider = IconFontProvider(FontAwesomeSolid5.PAUSE_CIRCLE)
        val INTERLOG_PAUSE: IconProvider = IconFontProvider(FontAwesomeSolid5.PLAY_CIRCLE)
        val INTERLOG_ICON: IconProvider = IconFontProvider(FontAwesomeSolid5.BOOK)
        val ICON_SAVE_AS: IconProvider = IconFontProvider(FontAwesomeSolid5.FILE_CODE)
